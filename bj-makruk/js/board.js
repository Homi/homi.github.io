...
var brd_colPceNum = new Array(2);	

// Honour Rules

var brd_BHV_value = 64;
var brd_BHV_count = 0;
var brd_PHV_value = 0;
var brd_PHV_count = 0;

var brd_HR_count = 0;
var brd_HR_OK = BOOL.FALSE;
var brd_HR_flag = BOOL.FALSE;
var brd_HR_weak = COLOURS.BOTH;
var brd_HR_piece = '';

var BHV_flag = BOOL.FALSE;
var PHV_flag = BOOL.FALSE;
...
function ResetBoard() {
	...
	brd_HR_OK = BOOL.FALSE;
	brd_HR_flag = BOOL.FALSE;
	brd_HR_weak = COLOURS.BOTH;
	brd_HR_piece = '';
	brd_HR_count = 0;
}
...
function ParseFen(fen) {
	...
	while ((rank >= RANKS.RANK_1) && fenCnt < fen.length) {
		...
		switch (fen[fenCnt]) {
			...
			case 'c': piece = PIECES.bC; break;
            case 'k': piece = PIECES.bK; break;
			case 'm': piece = PIECES.bM; break;
            case 'P': piece = PIECES.wP; break;
            case 'R': piece = PIECES.wR; break;
            case 'N': piece = PIECES.wN; break;
			case 'C': piece = PIECES.wC; break;
